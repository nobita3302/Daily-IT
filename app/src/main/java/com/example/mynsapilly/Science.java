...
public class Science extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        recyclerViewofscience = v.findViewById(R.id.sciencerecylerview);
    ...
    {
        ApiClass.getApiInterfae().getCategoryNews(country,"science",100,apikey).enqueue(new Callback<mainNews>() {
            @Override
