...
public class Health extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        recyclerViewofhealth = v.findViewById(R.id.healthrecylerview);
    ...
    {
        ApiClass.getApiInterfae().getCategoryNews(country,"health",100,apikey).enqueue(new Callback<mainNews>() {
            @Override
