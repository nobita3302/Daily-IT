...
public class business extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        recyclerViewofbusiness = v.findViewById(R.id.businessrecylerview);
    ...
    {
        ApiClass.getApiInterfae().getCategoryNews(country,"business",100,apikey).enqueue(new Callback<mainNews>() {
            @Override
